...
public final class Main {
    ...
    private static JPanel buildControls(SwingChartPanel chartPanel, JFrame[] frameRef) {
        ...
        row1.add(autoFitBox); row1.add(nonNegativeBox); row1.add(resetButton); row1.add(fitYButton);
        ...
        row3.add(playButton); row3.add(pauseButton); row3.add(restartButton); row3.add(forwardButton); row3.add(liveButton);
