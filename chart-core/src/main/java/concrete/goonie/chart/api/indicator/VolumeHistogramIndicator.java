 ...
 */
public final class VolumeHistogramIndicator extends AbstractIndicator implements ConfigurableIndicator {
    ...
    public List<IndicatorProperty> getProperties() {
        return List.of(
                ...
                new IndicatorProperty("mode", "Render", IndicatorPropertyType.TEXT, "Histogram", false)
        );
    }
