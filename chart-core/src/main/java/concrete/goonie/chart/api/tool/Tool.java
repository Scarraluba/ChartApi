...
public abstract class Tool {
    ...
    /**
     * Returns the hit distance in pixels for hover/selection ranking. Lower is better.
     */
    public double hitTestDistancePx(Transform transform, int screenX, int screenY) {
        return hitTest(transform, screenX, screenY) ? 0.0 : Double.POSITIVE_INFINITY;
    }
